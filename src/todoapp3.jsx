...
const Item = (props) => {
  ...
  return (
    <ListItem
      leftCheckbox={<Checkbox checked={checked} onCheck={handleFinish} />}
      primaryText={itemName()}
      secondaryText={`登録日: ${saveTime} / 完了日: ${finishTime}`}
      rightIconButton={<RaisedButton label="削除する" secondary onClick={handleDelete} />}
    />
  );
};
Item.propTypes = {
